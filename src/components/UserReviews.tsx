...
const initialReviews: UserReview[] = [
  {
    ...
    rating: 5,
    comment:
      "هذه الأحذية مريحة للغاية وأنيقة. الحرفية ممتازة، وتبدو أفضل من الصور. لقد تلقيت العديد من الإطراءات بالفعل!",
  },
  {
    id: 2,
    name: "Emma Johnson",
    ...
    rating: 4,
    comment:
      "الجلد عالي الجودة والمقاس مناسب تمامًا. طلبت مقاسي المعتاد وكان ملائمًا تمامًا. السبب الوحيد الذي يجعلني أعطي 4 نجوم بدلاً من 5 هو أنها احتاجت لبعض الوقت لتكسر.",
  },
  {
    id: 3,
    name: "James Wilson",
    ...
    rating: 5,
    comment:
      "جودة استثنائية واهتمام دقيق بالتفاصيل. هذه الأحذية تستحق كل قرش – مستوى الراحة مذهل، وتتناسق بشكل رائع مع الملابس الرسمية والعادية على حد سواء.",
  }
