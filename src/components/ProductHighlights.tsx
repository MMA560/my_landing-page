...
const highlightsData: HighlightProps[] = [
  {
    ...
    description:
      "كوتشي Nike SV5 مصنوع من خامات عالية الجودة مستوردة بعناية لضمان المتانة والشكل الأنيق في كل استخدام.",
    iconName: "leather",
  },
  {
    title: "راحة تدوم طوال اليوم",
    description:
      "فرش طبي داخلي يوفر دعم مثالي لقدميك، لتتحرك براحة تامة مهما طال يومك.",
    iconName: "comfort",
  },
  {
  ...
  },
  {
    ...
    description:
      "كوتشي مثالي للمشاوير اليومية والخروجات، بتلبيسة مظبوطة تضمن الثبات والانسيابية في الحركة.",
    iconName: "eco",
  },
];
